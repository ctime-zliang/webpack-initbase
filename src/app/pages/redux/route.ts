...
import { modulesInjectReducer } from '@/app/store/redux'
import { TRouteItem } from '@/app/utils/hoc/renderRoutes/renderRoutes'
/* ... */
import { createReducer as counter_createReducer, initialState as counter_initialState } from '@/app/store/redux-counter/reducer'
import { TStore as counter_TStore } from '@/app/store/redux-counter/types'
import { moduleKey as counter_moduleKey } from '@/app/store/redux-counter/config'
/* ... */
import { createReducer as timeStamp_createReducer, initialState as timeStamp_initialState } from '@/app/store/redux-timeStamp/reducer'
import { TStore as timeStamp_TStore } from '@/app/store/redux-timeStamp/types'
import { moduleKey as timeStamp_moduleKey } from '@/app/store/redux-timeStamp/config'
